...
| **Dossier with country seal** — On return from state visit you receive a dossier with the country seal; click to open and see deputy handover and what they did while you were away. Event feed "View dossier" and desk "Recent dossiers" open the modal. | Formal briefs with country branding; handover details (gap 2.1, 2.3). |
