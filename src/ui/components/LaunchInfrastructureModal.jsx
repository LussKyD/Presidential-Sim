...
export default function LaunchInfrastructureModal({ state, onPick, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontWeight: 800, fontSize: 16, marginBottom: 8, color: '#e7e9ea' }}>Launch infrastructure project</div>
        <div style={{ fontSize: 12, color: '#8b98a5', marginBottom: 16 }}>Choose a region for the site visit and ribbon-cutting. Boosts regional and national approval (6-month cooldown).</div>
